...
{
	session.setAttribute("message","Your Not  NORMAL USER !! DO NOT ACCESS THESE PAGE..");
	response.sendRedirect("login.jsp");
	return;
}
								...
								<div class="container text-center">
									...
									<div class="card-footer" style="background-color: white;">
										<button type="button" class="btn btn-primary"
											style="font-size: 20px;" onclick="add_to_cart(<%=p.getpId() %>,'<%=p.getpName()%>',<%=p.gettingPriceAfterApplyingDiscount() %>)">Add To Cart</button>
